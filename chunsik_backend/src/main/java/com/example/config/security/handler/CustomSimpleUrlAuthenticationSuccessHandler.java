...
import com.example.config.security.OAuth2Config;
import com.example.config.security.util.CustomCookie;
import com.example.domain.entity.user.Token;
import com.example.domain.mapping.TokenMapping;
import com.example.repository.auth.CustomAuthorizationRequestRepository;
import com.example.repository.auth.TokenRepository;
import com.example.service.auth.CustomTokenProviderService;
...
import static com.example.repository.auth.CustomAuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
