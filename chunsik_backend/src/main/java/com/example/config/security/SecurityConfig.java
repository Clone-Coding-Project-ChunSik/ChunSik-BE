...
import com.example.config.security.handler.CustomSimpleUrlAuthenticationFailureHandler;
import com.example.config.security.handler.CustomSimpleUrlAuthenticationSuccessHandler;
import com.example.config.security.token.CustomAuthenticationEntryPoint;
import com.example.config.security.token.CustomOncePerRequestFilter;
import com.example.repository.auth.CustomAuthorizationRequestRepository;
import com.example.service.auth.CustomDefaultOAuth2UserService;
